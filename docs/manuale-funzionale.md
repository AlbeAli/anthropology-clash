...
Versione 0.26 — 2026-09-22 — Stato: pubblicato (M1-M4 chiuse; M5: 15 scenari scritti, validazione finale in corso, §16.6)
...
3. Chiudere M5 (rilettura degli scenari 04-15, §16.6): finché M5 resta aperta non si scrivono scenari nuovi.
4. Tre scenari sul consumo, uno per sessione, con la procedura di §16.6 invariata: fonte primaria letta, ogni citazione confrontata sul testo, `deepen` con sole letture verificate. Ciascuno si apre con un `hook` contemporaneo e risale al caso etnografico.
